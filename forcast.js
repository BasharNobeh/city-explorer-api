class Forcast {
  constructor() {
    ...
    this.lat = weatherData.map((lat) => lat.lat);
    this.lon = weatherData.map((lon) => lon.lon);
  ...
  AmmanCoordinates() {
    return [this.lat[2], this.lon[2]];
  }

  ParisCoordinates() {
    return [this.lat[1], this.lon[1]];
  }
...
module.exports.ammancoordinates = data.AmmanCoordinates();
module.exports.parisCoordinates = data.ParisCoordinates();
module.exports.seattleCoordinates = data.SeattleCoordinates();
